...
- Restored Big Picture EventStorming under Needfinding and moved Ubiquitous
  Language to section 2.3.6.
- Restored the Sprint column in the Product Backlog and the official Sprint 1
  section order.
- Restored Aspect Leaders and Collaborators, Markdown Contents, and the
  Student Outcome format.
- Reconciled official report headings and PDF front-matter order.

### Changed

- Reordered the Product Backlog by business value and refined Sprint 1 planning
  and Sprint Goal.
...
- Report structure, internal links, bibliography citation coverage, whitespace,
  and PDF rendering were checked against the candidate; detailed results and
  external-evidence limits are recorded in `docs/releases/v0.1.1.md`.
...
- This release does not claim direct interview findings, mobile implementation,
  device execution, deployment, or user validation without their corresponding
  public evidence.
