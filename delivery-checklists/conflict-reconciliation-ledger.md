...
| `report/02-requirements-and-software-solution-design/2.4-requirements-specification/2.4.1-user-stories.md`, `2.4.2-impact-mapping.md`, `2.4.3-product-backlog.md` | A/D | Exact V1 target map and 28-story backlog with open impact metrics | Broad scenarios and stale 49-story/7-epic planning baseline | Approved V1 story register and Blueprint | Keep feature V1 requirements; do not carry stale totals as current scope | Resolved and included in `86351b3` |
