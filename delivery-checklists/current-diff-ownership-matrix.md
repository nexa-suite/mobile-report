...
| Field | Value |
| :--- | :--- |
| Snapshot | 2026-09-02; branch `feature/report-front-matter-and-governance` |
| Base | `3edeb196800a72a30299987a661e791c8f8fb50d` |
| Recovery copy | `/tmp/nexa-mobile-report-resume.PJofE0/` |
| Staging | EMPTY at snapshot; current staging authorization cleared by approved handoff |
