...
| `893e8ecfca3be86f66c0fd2fcf1c7ebff78a3e3d` | Architecture authority and boundary evidence | `DiegoS284` / `diego64g284@gmail.com` | `VALID` — GitHub verified |
| `55c10fdd5fec43f8d24bc82e928d91c010753c7f` | Mobile architecture/runtime-boundary evidence | `GerardRojasMancilla` / `U202413142@upc.edu.pe` | `VALID` — GitHub verified |
