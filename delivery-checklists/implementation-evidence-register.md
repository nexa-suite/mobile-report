...
| `mobile-report` — report at current audit snapshot | `reconcile/report-integration-20260902` / `a4300002c165cc250493258aa748989976a26799` / 2026-09-02 | Current reconciled report after seven post-audit commits; the branch and commit sequence are recorded in [human-commit-gate.md](./human-commit-gate.md) | A merged PR, human visual/story defense, Mobile runtime, user research closure or production readiness |
