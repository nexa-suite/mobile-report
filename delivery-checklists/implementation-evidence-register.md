...
| Canonical story transcription | Full report lifecycle and V1 projection match the current product registry | `python3 scripts/verify-mobile-v1-transcription.py` → full catalog 73 stories; 256 source scenarios plus 3 reconciled Gherkin scenarios for MOB-US-073; V1 projection 28 stories; individual defense and Product Acceptance remain open | Partial |
