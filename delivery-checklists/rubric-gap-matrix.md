...
| § Capítulo III, p. 313–334 y 609–638 | Style Guidelines, IA, landing wireframe/mock-up y Mobile wireframes/wireflows/mock-ups/user flows/prototype | [Chapter III](../report/03-solution-ui-ux-design/chapter-overview.md) y [Design Lab-to-Mobile crosswalk](../report/03-solution-ui-ux-design/3.1-product-design/3.1.4-mobile-applications-ux-ui-design/3.1.4.1-mobile-application-wireframes.md) | Design Lab source observed; target reconciled; rendered Mobile evidence pending | Adjuntar archivos Figma/LucidChart/Overflow, exportaciones, viewport, estados felices/no felices, video de prototipo y revisión UX. Owner: UX lead. |
