...
Statements y un Lean UX Canvas. La segmentación objetivo se formaliza en la
sección 1.3.
...
| **How Much — ¿Qué magnitud tiene?** | La magnitud específica para Nexa no está cuantificada en esta etapa de problem framing. | **No cuantificado como línea base.** Los datos externos no deben transformarse en porcentajes atribuidos a los usuarios de Nexa. |
...
| **Validación** | La investigación primaria debe contrastar problemas, tareas y restricciones sin convertir fricciones, frecuencias, costos o beneficios esperados en resultados demostrados. |
...
La sección 1.2.1 establece así una base deliberadamente preliminar: la evidencia
secundaria justifica investigar continuidad, trazabilidad y trabajo móvil dentro
del ciclo B2B, sin cuantificar su magnitud ni anticipar qué solución concreta
será más efectiva. Estas preguntas se transformaron en assumptions e hypotheses
en el Lean UX Process de la sección 1.2.2.
