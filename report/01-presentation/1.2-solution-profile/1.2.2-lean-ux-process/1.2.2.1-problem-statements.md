...
Mobile V1**. Sales Representative permanece como actor de Nexa, pero su movilidad
comercial no forma parte del núcleo Mobile V1 y podrá evolucionar posteriormente
como una conveniencia V2+ dentro de Nexa Operations Mobile. La investigación no
...
> *Nota.* Elaboración propia a partir del proceso aplicado en Nexa y del Lean UX
> Canvas de Gothelf y Seiden (2021).
...
(INEI, 2025a; Grupo Lucky, 2022). Estas fuentes no describen directamente a los
...
Nexa abordará esta brecha mediante una **estrategia de coordinación Mobile
centrada en preservar contexto útil cuando cambia la responsabilidad sobre el
pedido**. La propuesta busca que cada participante pueda reconocer la tarea que
le corresponde, comprender los hechos relevantes de las etapas anteriores y
...
- interacción compatible con actividades físicas y móviles;
- soporte de lote, vencimiento o condición cuando la operación lo requiera.

La estrategia no presupone que una tecnología específica sea la respuesta. El
...
del foco Mobile V1 de esta investigación**. Su posible movilidad comercial se
considera una evolución posterior de conveniencia dentro de Nexa Operations
Mobile y no se fusiona nuevamente con Warehouse & Dispatch Operations.
...
> *Nota.* Los indicadores orientan la obtención de una línea base. Los valores
> objetivo se definirán antes de cada validación y no se inventan en esta etapa.
...
- la cadena de frío se considera cuando corresponda y no como requisito
  universal;
- Sales Mobile se mantiene fuera del núcleo V1;
