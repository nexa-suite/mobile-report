 ...
 *Nota.* Los indicadores expresan qué observar. La línea base se obtiene antes de cada validación. Cualquier valor numérico se fija antes del experimento a partir de esa línea base y no se interpreta como resultado de validación.

###### Criterios de cierre del ciclo de aprendizaje
 ...
 *Nota.* La tabla preserva ideas previamente exploradas sin convertirlas en hypotheses separadas. Cada capacidad deberá justificarse mediante la investigación del recorrido principal al que sirve.
 ...
 *Nota.* Elaboración propia. La figura muestra la relación principal utilizada para construir las Hypothesis Statements.

##### Relación entre assumptions
