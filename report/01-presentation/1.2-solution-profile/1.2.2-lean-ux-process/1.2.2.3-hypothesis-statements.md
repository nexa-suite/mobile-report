 ...
 *Nota.* La matriz utiliza la relación principal necesaria para formular cada hypothesis. El resto de las assumptions continúa proporcionando contexto y deberá contrastarse mediante investigación.
 ...
 *Nota.* Esta tabla define criterios de aprendizaje; no registra decisiones ya tomadas ni evidencia de validación.

##### Priorización inicial de aprendizaje

Las tres hypotheses se consideran de valor potencial alto porque abordan
transiciones relevantes dentro del problema central. Como **supuesto inicial
del equipo**, la prioridad de aprendizaje se coloca en **H1 — Continuidad
Warehouse & Dispatch** por combinar alto valor percibido, alta incertidumbre y
un riesgo de continuidad aguas arriba: si el contexto no se conserva entre
preparación, readiness y handoff, la propuesta puede perder valor antes de que
las demás transiciones puedan beneficiarse de ella.
...
| --- | --- | --- | --- |
| **H1 — Warehouse & Dispatch** | Alta | Alta | Primera hipótesis priorizada en la secuencia inicial |
| **H2 — Driver Delivery Execution** | Alta | Alta | Segunda posición en la secuencia inicial de aprendizaje |
| **H3 — B2B Buyers** | Alta | Alta | Tercera posición en la secuencia inicial de aprendizaje |

La tabla registra la secuencia de aprendizaje definida al formular Lean UX; no
expresa el estado de validación de la solución.
...
La secuencia inicial situaba H2 y H3 después de H1; ese orden representaba la
prioridad de aprendizaje propuesta y podía revisarse a medida que apareciera
nueva evidencia. Las tres hypotheses continúan siendo parte del mismo baseline;
la prioridad no convierte H1 en una feature aceptada ni elimina H2 o H3.
 ...
 *Nota.* Elaboración propia. La prioridad representa el orden inicial de aprendizaje, no una decisión irreversible de alcance.
