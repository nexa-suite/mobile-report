...
Este segmento reúne las personas que reciben, identifican, preparan o coordinan
la salida física de la mercadería. Warehouse Operator y Dispatch Coordinator
mantienen responsabilidades distintas, pero necesitan preservar contexto entre
preparación, readiness y handoff. La cadena de frío, los lotes, los vencimientos
y las condiciones de conservación se consideran cuando son parte real de la
operación, no como requisitos universales.

#### MOB-SEG-02 — Driver Delivery Execution

Este segmento representa a quien traslada una entrega desde el despacho hasta el
punto de recepción. Driver / Delivery Operator ejecuta la Delivery asignada y
registra el resultado de cada Delivery Attempt, sus incidencias y la evidencia
que corresponda. La movilidad, conectividad, batería, clima y seguridad física
son condiciones que justifican investigar su contexto de uso; no se presupone
tracking continuo, ruteo avanzado ni una política única de evidencia.

#### MOB-SEG-03 — B2B Buyers

Este segmento representa a Customer Buyers autorizados que mantienen una relación
comercial con el Tenant proveedor. Su foco abarca abastecimiento, coordinación
con proveedores, puntualidad, llegada y, cuando corresponde, recepción o
discrepancia. Buyer Receipt se mantiene separado del resultado declarado por
Driver / Delivery Operator, pues ambos hechos pertenecen a perspectivas y
responsabilidades diferentes.

Los tres segmentos permiten estudiar cambios de responsabilidad dentro de una
misma operación B2B sin fusionar Warehouse, Dispatch, Driver y Buyer en un solo
actor ni trasladar todo el ciclo comercial al teléfono.
