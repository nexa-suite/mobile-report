...
foco actual de Product e investigación Mobile V1**. Su propósito no es dividir
...
Esta segmentación constituye el **foco actual aceptado de Mobile V1**. La
...
permanecen como una posible evolución **V2+ de conveniencia dentro de Nexa
...
mantiene el foco V1 en tareas donde la movilidad forma parte del contexto
operativo principal.
...
flowchart TD
    ...
    V2 --> S["Sales Representative"]
    V2 --> BOM["Business Operations Manager"]
```

> *Nota.* El diagrama diferencia el foco Mobile V1 de posibles capacidades de
...
> tres segmentos objetivo Mobile V1. Elaboración propia.
...
#### Necesidades y fricciones a investigar
...
La navegación V1 se concibe como un **handoff hacia navegación externa cuando sea
...
mantienen una relación comercial con el Tenant proveedor. El foco Mobile V1 no
...
Buyer Mobile V1 permanece deliberadamente acotado. Catálogo completo, gestión
...
Nexa Mobile V1 concentra su investigación en **Warehouse & Dispatch Operations,
