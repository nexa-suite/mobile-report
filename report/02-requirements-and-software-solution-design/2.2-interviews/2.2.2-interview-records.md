...
| `MOB-SEG-03` | `INT-S3-01..02` | Se conservan dos entrevistas Buyer válidas; `INT-S3-03` queda reservado para alcanzar el mínimo de tres. |
...
ficha; las sesiones futuras deberán incorporarse al video de entrega con su
respectivo índice.
...
en la relación con el proveedor. La muestra todavía es menor al mínimo de
tres; `INT-S3-03` permitirá completar la cobertura específica de recepción,
verificación de lo esperado y discrepancias.
...
las dos entrevistas Buyer documentadas, utilizando el denominador real del
segmento con evidencia. Las entrevistas de otros perfiles quedan fuera del
análisis por no ser útiles para los segmentos móviles definidos.
