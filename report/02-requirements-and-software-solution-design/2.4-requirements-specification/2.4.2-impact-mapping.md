...
Las Functional User Stories utilizadas como hojas del mapa conservan sus identificadores y descripciones de la sección **2.4.1. User Stories**. El Impact Mapping no pretende incluir todo el catálogo funcional: prioriza únicamente las historias que presentan una relación directa con los Business Goals, Impacts y Deliverables representados. Las historias transversales de acceso y autorización permanecen en la especificación de requisitos y el Product Backlog, pero no introducen una cuarta Persona, ya que **Mobile User** es una abstracción funcional y no un User Persona de investigación.
