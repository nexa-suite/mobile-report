...
En estos objetivos, **línea base de validación** significa el valor inicial medido con el mismo escenario y criterios antes de evaluar la solución To-Be. La línea base aún debe levantarse; los porcentajes y umbrales son metas de evaluación, no resultados observados.
...
Las Functional User Stories utilizadas como hojas del mapa conservan sus identificadores y descripciones en la sección **2.4.1. User Stories**. Para Carlos Mendoza, las hojas son `MOB-US-044`, `MOB-US-047`, `MOB-US-048` y `MOB-US-049`. El Impact Mapping no pretende incluir todo el catálogo funcional: prioriza únicamente las historias que presentan una relación directa con los Business Goals, Impacts y Deliverables representados. Las historias transversales de acceso y autorización permanecen en la especificación de requisitos y el Product Backlog, pero no introducen una cuarta Persona, ya que **Mobile User** es una abstracción funcional y no un User Persona de investigación.
