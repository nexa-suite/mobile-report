...
El EventStorming colaborativo parte del Big Picture presentado en 2.3.5. Las
capturas conservan las etiquetas de trabajo del tablero (por ejemplo, Step 4 o
Step 10), pero el informe no las presenta como una metodología rígida de diez
pasos. Las actividades documentadas son exploración, timelines, pain points,
pivotal points, commands, policies, read models, límites de consistencia y
consolidación de Bounded Contexts.
