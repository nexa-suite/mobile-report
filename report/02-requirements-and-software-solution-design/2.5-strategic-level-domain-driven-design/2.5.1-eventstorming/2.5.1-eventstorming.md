...
Core, Supporting y Generic son una clasificación estratégica de Subdomains, no
tipos formales de Bounded Context. Nexa usa estas categorías para expresar la
alineación estratégica de cada Bounded Context; esto no cambia los once límites
de Bounded Context aceptados.

### Alineación estratégica de los Bounded Contexts de Nexa
...
*Alineación estratégica de los Bounded Contexts por relevancia estratégica.*
| Alineación estratégica | Bounded Contexts | Razón estratégica |
| :--- | :--- | :--- |
| Core-aligned | BC-04 Sales Commitment; BC-05 Inventory Availability; BC-06 Fulfillment & Delivery | Diferencian la coordinación entre obligación comercial, verdad física y resultado de entrega. |
| Supporting-aligned | BC-01 Tenant & Access Governance; BC-02 Customer & Buyer Relationships; BC-03 Catalog & Commercial Policy; BC-07 Credit & Receivables; BC-11 Business Traceability | Hacen posible operar de forma segura, elegible, configurable, financieramente consistente y explicable. |
| Generic-aligned | BC-08 Payments; BC-09 Business Documents; BC-10 Notifications | Aíslan capacidades comunes o sustituibles sin transferirles la autoridad de los hechos de negocio. |
...
La exploración estratégica comienza con eventos de dominio sin imponer de
inmediato límites técnicos. Cubre onboarding, relaciones con compradores,
catálogo, compromiso comercial, inventario, fulfillment, delivery, pagos,
documentos, notificaciones y trazabilidad. Su propósito es comprender el
dominio de extremo a extremo, no inferir una implementación ni dividirlo por
aplicaciones. El Big Picture EventStorming del needfinding se documenta por
separado en la sección 2.3.5 como artefacto de paisaje de negocio.
...
*Nota.* Artefacto de modelado para recorrer hechos y continuidad; no es evidencia de una funcionalidad implementada.
...
*Nota.* Artefacto de modelado para identificar cambios de responsabilidad; no crea límites técnicos por sí mismo.
...
*Nota.* Artefacto de modelado que formula riesgos a examinar; no es investigación de usuarios ni una clasificación automática de contextos.
...
*Nota.* Artefacto de modelado para localizar cambios de autoridad y consistencia; no equivale a un endpoint, paquete o servicio.

Los hallazgos de la exploración se transformaron en puntos observables donde
...
*Nota.* Artefacto de modelado que separa intención, decisión y hecho confirmado; no declara contratos API implementados.
...
*Nota.* Artefacto de modelado de reacciones e invariantes; no demuestra propagación o runtime ejecutado.
...
*Nota.* Artefacto de modelado de información de lectura; una proyección no obtiene autoridad del contexto fuente.
...
*Nota.* Artefacto de modelado de consistencia interna; Aggregate no equivale a Bounded Context, tabla ni container C4.

El tablero propone etiquetas de consistencia como Tenant Governance Policy,
Buyer Account, Commercial Catalog, SalesOrder, Commercial Commitment, Inventory
Reservation, Warehouse Backing, Physical Allocation,
Fulfillment Execution, Receivable Account, Payment Transaction, Document
Registry, Notification Dispatch y Business Traceability. Aggregate no es
Bounded Context, tabla, Spring module ni C4 Container.
...
*Nota.* Artefacto de consolidación de los once límites aceptados; Mobile y capacidades de dispositivo no se convierten en contextos.
...
La sección Candidate Context Discovery explica `look-for-pivotal-events`,
`start-with-value`, candidatos y alternativas. Domain Storytelling documenta
cinco Domain Stories; Bounded Context Canvases conserva los once canvases como
lectura Markdown.
