...
`start-with-value`, candidatos y alternativas. Domain Message Flows Modeling
documenta cinco Domain Stories; Bounded Context Canvases conserva los once
canvases como lectura Markdown.
