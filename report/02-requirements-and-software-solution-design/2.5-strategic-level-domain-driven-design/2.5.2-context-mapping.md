...
```mermaid
flowchart LR
  BC01["BC-01 Tenant & Access Governance"] -->|authorized Tenant/Workspace context| scoped["BC-02..BC-11 tenant-scoped operations"]
  missing["missing or ambiguous scope"] -->|fail closed| deny["operation denied"]
  BC01 --> scoped
```
...
la autorización de objeto y las predicadas del servidor siguen siendo
obligatorias.
...
| :--- | :--- | :--- |
| BC-01 hacia contextos tenant-scoped | Customer/Supplier con contexto autorizado | BC-01 controla scope; cada consumidor valida objeto y operación. |
