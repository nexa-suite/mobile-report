...
Las once vistas específicas se exportaron como SVG desde Structurizr DSL,
reutilizando el modelo canónico de Blueprint y agregando únicamente
definiciones de vista enfocadas. Son evidencia de diseño TARGET, no de
