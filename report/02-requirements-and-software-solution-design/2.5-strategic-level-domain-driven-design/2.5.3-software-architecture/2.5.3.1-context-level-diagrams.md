...
actores en la proyección objetivo; no aparecen como nuevos actores ni como BCs.
...
![Nexa system context — TARGET](../../../assets/chapter-2/c4/Nexa-SystemContext-TARGET.png)

La imagen es la vista L1 TARGET exportada desde la fuente semántica C4. El
 sistema sigue siendo un solo Nexa; las dos superficies móviles permanecen
 `TARGET / PLANNED / PROPOSED`. La imagen se interpreta como export de diseño
 desde la fuente semántica C4 y no como evidencia de ejecución.
