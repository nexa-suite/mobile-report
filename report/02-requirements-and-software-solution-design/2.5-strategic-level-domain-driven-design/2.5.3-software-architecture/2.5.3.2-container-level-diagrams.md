...
Las vistas AS-IS y V1 TARGET fueron observadas en el corte de diseño. Falta
seleccionar el export final, confirmar con el equipo las tecnologías y
relaciones que se afirmarán en el informe y registrar la revisión visual. El
export TARGET no demuestra implementación Mobile.
