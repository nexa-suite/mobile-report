...
| Operations Mobile | Android/Kotlin/Jetpack Compose. | HTTPS contra contratos autorizados; revalidación servidor de identidad, Tenant/Workspace y permisos de workforce. |
| Buyer Mobile | Flutter/Dart en Android+iOS. | HTTPS contra contratos autorizados; revalidación servidor de Buyer Relationship y estado de negocio. |

*Vista C4 L2: containers de Nexa.*

![Vista C4 L2 TARGET V1: containers de Nexa](../../../assets/chapter-2/c4/Nexa-Containers-V1-TARGET.svg)
