...
Esta sección reúne el paquete de Class Diagram del Domain Layer y Database
Diagram del contexto candidato. Los artefactos distinguen el diseño objetivo
del código actual y de la persistencia observada.

No se crearán diagramas de código para Mobile como si la aplicación fuese un
Bounded Context.
