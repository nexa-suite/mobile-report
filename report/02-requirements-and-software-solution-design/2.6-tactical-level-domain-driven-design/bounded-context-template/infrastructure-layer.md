...
En esta capa se documentarán las implementaciones de Repository, el acceso a PostgreSQL, la mensajería y los adaptadores de servicios externos que correspondan al Bounded Context. La persistencia compartida del modelo aceptado no significa que todos los contextos compartan ownership de las mismas tablas.
