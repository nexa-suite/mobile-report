# Annex B: Participant Performance Report

Documentar la evaluación individual de cada integrante en escala de 0 a 20 para
cada entrega. Este corte prepara el registro, pero no asigna calificaciones ni
atribuye desempeño sin revisión del Team Leader y de la persona evaluada.
...
Cada calificación debe ser un valor de `0` a `20` respaldado por acciones
observables de la entrega correspondiente, fuente o artefacto, commit o enlace
revisado, explicación del participante y aprobación del Team Leader. Un nombre
de autor en Git no sustituye esta evaluación.
