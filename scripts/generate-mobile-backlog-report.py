...
DESCRIPTIONS: dict[str, str] = {
    ...
    "MOB-US-005": "Como Business Operations Manager, quiero identificar excepciones operativas críticas, para atender trabajo bloqueado antes de que retrase a un customer o una delivery.",
    ...
    "MOB-US-019": "Como Warehouse Operator, quiero registrar evidencia de temperatura para el stock relevante, para que las decisiones de cadena de frío usen una lectura física atribuible.",
    "MOB-US-020": "Como Dispatch Coordinator, quiero ver las entregas listas para preparación del despacho, para preparar únicamente entregas listas para salir del almacén.",
    ...
    "MOB-US-024": "Como Dispatch Coordinator, quiero identificar de forma confiable un handoff de despacho, para mantener vinculados la entrega correcta y el driver durante todo el handoff.",
    "MOB-US-025": "Como Dispatch Coordinator, quiero confirmar que los bienes dejaron el control del almacén, para que todos puedan confiar en el estado del despacho de la entrega.",
    ...
    "MOB-US-030": "Como Driver or Delivery Operator, quiero contactar al comprador durante la entrega, para resolver una duda de llegada mediante un canal autorizado.",
    ...
    "MOB-US-035": "Como Driver or Delivery Operator, quiero continuar la evidencia de entrega después de perder conexión, para que un flujo futuro de recuperación proteja la evidencia sin afirmar éxito falso.",
    "MOB-US-036": "Como Customer Buyer, quiero explorar productos del proveedor, para revisar productos ofrecidos mediante mi relación con el proveedor.",
    "MOB-US-037": "Como Customer Buyer, quiero revisar el precio y disponibilidad del producto, para preparar una solicitud futura con información actual del proveedor.",
    ...
    "MOB-US-039": "Como Customer Buyer, quiero repetir una compra anterior, para preparar una nueva solicitud más rápidamente en un flujo futuro.",
    ...
    "MOB-US-042": "Como Customer Buyer, quiero seguir solicitudes y pedidos, para comprender el progreso comercial autorizado.",
    "MOB-US-043": "Como Customer Buyer, quiero revisar el estado del crédito y del pago, para comprender lo adeudado sin tratar la evidencia reportada como confirmación.",
    ...
    "MOB-US-045": "Como Customer Buyer, quiero ver en un mapa un conductor activo, para que un servicio futuro y autorizado me ayude a comprender el horario de llegada.",
    "MOB-US-046": "Como Customer Buyer, quiero contactar al conductor, para resolver una duda de llegada mediante un canal autorizado de entrega.",
    "MOB-US-047": "Como Customer Buyer, quiero verificar una entrega mediante el código de handoff, para confirmar que reviso la entrega correcta.",
    ...
    "MOB-US-050": "Como Warehouse Operator, quiero registrar una discrepancia de recepción de entrada con evidencia, para que la decisión de recepción refleje lo encontrado físicamente.",
    "MOB-US-051": "Como Warehouse Operator, quiero colocar stock cuestionable en retención o cuarentena y registrar su resolución, para impedir su uso antes de una decisión autorizada.",
    ...
    "MOB-US-054": "Como Warehouse Operator, quiero solicitar una sustitución permitida de lote cuando el lote esperado no puede completar el trabajo, para revisar el pedido sin omitir la política de disponibilidad.",
    ...
    "MOB-US-057": "Como Dispatch Coordinator, quiero resolver una discrepancia de despacho antes del handoff, para que solo una entrega revisada abandone el control del almacén.",
    "MOB-US-058": "Como Dispatch Coordinator, quiero reasignar un driver o reprogramar un despacho de forma segura, para que la entrega siga siendo responsabilidad de una persona elegible en un momento acordado.",
    "MOB-US-059": "Como Dispatch Coordinator, quiero preparar una carga de entrega agrupada con sus paradas, para despachar entregas compatibles manteniendo visibles sus restricciones.",
    "MOB-US-060": "Como Dispatch Coordinator, quiero completar un handoff al transportista con responsabilidad clara, para que todos sepan quién controla la carga después de que abandona el almacén.",
    "MOB-US-061": "Como Dispatch Coordinator, quiero registrar evidencia de temperatura en el despacho, para que la decisión de entrega refleje la condición observada antes del handoff.",
    "MOB-US-062": "Como Driver or Delivery Operator, quiero señalar la llegada de una entrega activa, para que el comprador y el equipo de entrega sepan que puede comenzar el handoff.",
    ...
    "MOB-US-065": "Como Driver or Delivery Operator, quiero registrar un incidente de entrega con sus detalles relevantes, para que el equipo tome una decisión de seguimiento informada.",
    "MOB-US-066": "Como Driver or Delivery Operator, quiero conservar evidencia seleccionada de entrega durante una pérdida de conexión, para recuperar el trabajo sin afirmar un resultado de entrega no confirmado.",
    "MOB-US-067": "Como Customer Buyer, quiero proporcionar instrucciones de entrega y un contacto alternativo para la recepción, para que la entrega llegue a la persona correcta bajo las condiciones acordadas.",
    "MOB-US-068": "Como Customer Buyer, quiero revisar la línea de tiempo de la entrega y reconocer su finalización, para comprender el resultado registrado sin cambiar el historial.",
    "MOB-US-069": "Como Customer Buyer, quiero adjuntar evidencia a una discrepancia de entrega, para que el proveedor revise la diferencia reportada con su contexto.",
    "MOB-US-070": "Como Customer Buyer or Sales Representative, quiero ver un documento de negocio vinculado a una solicitud o un pedido, para usar la evidencia autorizada del trabajo comercial.",
    "MOB-US-071": "Como Customer Buyer, quiero reportar evidencia de pago y ver su resultado de revisión, para seguir un pago sin afirmar yo mismo su confirmación.",
    ...
    "MOB-US-073": "Como Warehouse Operator, quiero revisar observaciones avanzadas de almacén mediante una decisión controlada, para que una automatización futura ayude al trabajo sin convertirse en verdad de stock no examinada.",
}
